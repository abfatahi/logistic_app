  ...
  return (
    ...
    >
      <path
        ...
        stroke="url(#Ellipse2_svg__paint0_radial)"
        strokeWidth={3}
      />
      <defs>
        <radialGradient
          id="Ellipse2_svg__paint0_radial"
          cx={0}
          cy={0}
          r={1}
          gradientUnits="userSpaceOnUse"
          gradientTransform="rotate(14.088 -313.28 -191.356) scale(120.628 556.649)"
        >
